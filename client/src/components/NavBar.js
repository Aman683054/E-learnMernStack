                          ...
                          >
                            <nav className="main-nav">
                              ...
                              <li>
                                ...
                                <li>
                                  <a href={`${process.env.PUBLIC_URL}/ShowCourseList`}>
                                    COURSES
                                  </a>
                                </li>
                                <li>
                                  <a href={`${process.env.PUBLIC_URL}/ShowCategoryList`}>
                                    CATEGORIES
                                  </a>
                                </li>
                                <li>
                                  <a href={`${process.env.PUBLIC_URL}/EnrollmentList`}>
                                    ENROLLED USERS
                                  </a>
                                </li>
                                <li>
          ...
          var authLinks = (
            <React.Fragment>
              <li className="has-children has-children--multilevel-submenu">
                ...
                <li>
                  <a href={`${process.env.PUBLIC_URL}/servicesforstudent/`+users.id}>      
                    MY COURSES
                  </a>
                </li>
                <li>
        ...
        if(users.role == 'instructor')
          { 
            var authLinks = (
              ...
              <li>
              <a href={`${process.env.PUBLIC_URL}/finaldashboard`}>
                PROFILE
              </a>{" "}
              </li>
              {/* <li>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <li> <a herf =" http://localhost:5000/hostname/:id">
                              image
                            </a>
                            </li>
